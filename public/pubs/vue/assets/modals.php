       ...
       <div class="modal-body" >
        ...
        <div class="col-sm-4" >
          ...
          <div style="margin-bottom:5px;">
           ...
           <span class="glyphicon glyphicon-earphone"></span> Afficher le Numéro</button></div>
          ...
          <form class="form" method="post" action="">
            <div class="row">
             <div class="col-sm-6">
              <div class="form-group">
              <h4>E-mail :</h4>
                <input class="form-control" name="exp" placeholder="Votre E-mail" type="email" value="<?php echo $_SESSION['email'];?>" required autofocus ></input>
              </div>
              </div>
             <div class="col-sm-6" >
             <h4>Destinataire :</h4>
              <input class="form-control" name="dest[]" placeholder="E-mail destinataire" type="E-mail" required ></input>
            </div>
          </div>
