    ...
    <div id="MainMenu"  style="">
      <div class="list-group panel" style="border-color:#333;border-radius:0px;">
       ...
       <div class="collapse <?php echo $ancr;?>" id="m4">
         <a href="<?php echo $address;?>admin/annonceur/list" class="list-group-item">Liste des Utilisateurs</a>
       ...
       <div class="collapse <?php echo $art;?>" id="m3">
         <a href="<?php echo $address;?>admin/article/list" class="list-group-item">Liste des articles</a>
