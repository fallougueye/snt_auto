...
?>
   ...
   <h3 class="text-center text-muted"> Déposer une annonce :   </h3>
   <hr>
   <div class="panel panel-default">
   	<div class="panel-heading" style="padding-bottom:0;background-color:#900;">
     <p style="color:#fff;"><strong>FORMULAIRE DEPOT D'ANNONCE</strong></p>
   	</div>
         ...
         <div class="col-xs-3">
             ...
             <div class="col-xs-3">
                ...
                <option value="selectionnez"selected> -- Sélectionnez -- </option>
                    ...
                    <option value="2 cylindre" > 2 cylindre </option>
                    <option value="3 cylindre" > 3 cylindre </option> 
                <option value="4 cylindre" > 4 cylindre </option>
                <option value="5 cylindre" > 5 cylindre </option>
                    <option value="6 cylindre" > 6 cylindre </option>
                    <option value="7 cylindre" > 7 cylindre </option>
                    <option value="8 cylindre" > 8 cylindre </option>  
              </select>
             </div>
             <div class="col-xs-2">
...
<?php } ?>
                ...
                <p><span class="checkbox-inline">*En cliquant sur &quot;Enregistrez et Continuez&quot;, j'accepte les<a href=" <?php echo $address ?>/conditionsGenerales"> CGU, les CGV et la charte du bon annonceur.</a></span></p>
            </div>    
        </div>
      </div><!--Fin input Modèle -->
     </div>
