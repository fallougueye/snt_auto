...
<div class="row">
    <div class="col-md-12" style="background: #eeeeee;">
        ...
        <form action="<?php echo e(url('/autotheque/depot')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-xs-9">
                                <div class="preloader hide" id="preloader">
                                    <img src="<?php echo e(asset('images/loading.gif')); ?>" class="img-responsive center-block">
                                </div>
