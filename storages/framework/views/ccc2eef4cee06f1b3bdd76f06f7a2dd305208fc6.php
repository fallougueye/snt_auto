            ...
            <div class="row">
                <div class="col-md-3" style="margin-bottom:5px;">
                    <div class="thumbnail" style="margin-bottom:3px;"> 
                        <a href="<?php echo e(url('detail-annonce_moto-'.$ance->id)); ?>">
                            <?php if($ance->photos_principal != 'logo.png'): ?>
                                ...
                                <?php endif; ?>
                                <img src="<?php echo e(asset('images/annonce/moto/'.$ance->photos_principal)); ?>" class="img-responsive" width="98%" style="margin:2px;height: 107px;max-width: 142px;"> 
                        </a>
                            <?php else: ?>
            ...
            <div class="panel panel-default text-muted hidden-xs" style="padding:5px;"><?php echo $ance->titre ?></div>
                <div class="row"> 
                    ...
                    <div class="col-xs-4 col-sm-3">
                        <button class="btn btn-xs btn-default pull-right partager">
