                    ...
                    <div class="container-fluid col-md-6 col-md-offset-3">
                        ...
                        <form id="regForm" method="post" action="{{route('entreprise.ajouter')}}" enctype="multipart/form-data">
                            ...
                            <div class="tab">
                                ...
                                <p>
                                  <div class="titre"> <label>Ecole:</label></div>
                                <textarea class="form-control" style="width:100%; height:100px; " name="ecole" placeholder="ecole" value="" autocomplete="ecole" autofocus=""></textarea>
                                </p>

                                <p>
                                  <div class="titre"> <label>Localite:</label></div>
                                <textarea class="form-control" style="width:100%; height:100px; " name="localite" placeholder="ecole" value="" autocomplete="localite" autofocus=""></textarea>
                                </p>
