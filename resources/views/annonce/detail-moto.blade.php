...
<ol class = "breadcrumb">
   ...
   <li><a href = "{{ asset('annonce/moto')}}">Annonce moto</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="thumbnail"> 
                        <?php if($annonce->photos_principal == "logo.png"){
                            ...
                            <img src="{{ asset('images/annonce/moto/'.$annonce->photos_principal)}}" class="img-pp img-responsive" width="98%" height="98%"  style="margin:2px;cursor: pointer;">
                        <?php } ?>
                    </div> 
                    <div class="prix_a"> 
