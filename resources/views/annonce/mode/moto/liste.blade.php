            ...
            <div class="row">
                <div class="col-md-3" style="margin-bottom:5px;">
                    <div class="thumbnail" style="margin-bottom:3px;"> 
                        <a href="{{ url('detail-annonce_moto-'.$ance->id)}}">
                            @if($ance->photos_principal != 'logo.png')
                                <img class="tag" src="{{ asset('images/'.$ance->type_annonce.'.png')}}"> 
                                @if($ance->urgence == 1)
                                    <img class='tag_urgent' src="{{ asset('images/urgent_h.png')}}">
                                @endif
                                <img src="{{ asset('images/annonce/moto/'.$ance->photos_principal)}}" class="img-responsive" width="98%" style="margin:2px;height: 107px;max-width: 142px;"> 
                        </a>
                            @else
