...
@section('content')
    ...
    <ol class = "breadcrumb">
        ...
        <li class='active'>vehicules <span class='glyphicon glyphicon-play'></span> {{$type}}<span class='glyphicon glyphicon-play'></span> {{$categorie}}</li>
    </ol>
        ...
        @else
            @foreach( $annonces as $index => $ance )
                <div id="liste">
                    ...
                    @elseif($type == 'moto')
                        @include('annonce.mode.moto.liste')
                    @endif
                </div>
                <div id="grid" class="displaye">
                    ...
                    @elseif($type == 'moto')
                        @include('annonce.mode.moto.grid')
                    @endif
                </div>
            @endforeach
        @endif
