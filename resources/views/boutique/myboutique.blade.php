...
@section('content')
      ...
      ﻿<title> Boutique - Sn-TopAuto.com </title>
...
<ol class="breadcrumb">
    ...
    <li> Mes Boutique </li>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <p class="btn btn-success form-control"> <a href="{{ url('/creer/boutique')}}"><strong>Créer votre boutique</strong></a></p>
            </div>
            <hr>
        </div>
        <div>
            <div style="margin:15px;">
                <a href="https://www.sn-topauto.com/boutique/" class="list-group-item list-group-item-success"> Mes Boutiques </a>
            </div>
            </div>
        <div class="categories-list">
            @if($myboutiques)
                @foreach ($myboutiques as $annuaire)
                <?php 
                        ...
                        <div class="panel-body">
                            ...
                            <div class='row'>
                                ...
                                <div class='col-sm-2'>
                                    ...
                                    <a href="{{ url('boutique/'.$annuaire->id.'/'.str_replace(" ", "_" ,$annuaire->nom))}}" title=" Voir sa boutique ">
