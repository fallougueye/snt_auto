...
@section('title')
Sn-TopAuto.com - sécurité Routiere
@endsection
...
@section('content')
    ...
    <ol class = "breadcrumb">
        ...
        <li><a href = "{{ url('securiteRoutiere')}}">Sécurité Routiere</a></li>
    </ol>
    <div style="padding-bottom:10px;">
        <div class="panel panel-danger">
            <div class="panel-heading" style="background:#900;color:#fff;">
                <strong>Sécurité Routiere</strong>
            </div>
                ...
                @if(count($articles) <= 0)
                    <div class="panel panel-danger">
                        <div class="panel-body text-muted">
                            ...
                            <span class="aac"> Aucune article de Sécurité Routiere </span> 
                        </div>  
                    </div>
                @else
